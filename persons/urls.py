...
from .views import validate_nationalid, check_nationalid, validate_mobile, check_mobile_exists, validate_cardnumber
...
urlpatterns = [
    ...
    path('validate_cardnumber/<str:cardNumber>/', validate_cardnumber, name='validate_cardnumber'),
]